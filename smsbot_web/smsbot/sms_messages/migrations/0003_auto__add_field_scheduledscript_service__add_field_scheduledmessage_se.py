...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledScript.service'
        db.add_column('sms_messages_scheduledscript', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scripts', null=True, to=orm['services.Service']),
                      keep_default=False)

        # Adding field 'ScheduledMessage.service'
        db.add_column('sms_messages_scheduledmessage', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', null=True, to=orm['services.Service']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledScript.service'
        db.delete_column('sms_messages_scheduledscript', 'service_id')

        # Deleting field 'ScheduledMessage.service'
        db.delete_column('sms_messages_scheduledmessage', 'service_id')
    ...
    models = {
        ...
        'sms_messages.scheduledscript': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'default': "'a8c57c56-8b31-4de7-8043-c834fffb517b'", 'unique': 'True', 'max_length': '36'}),
