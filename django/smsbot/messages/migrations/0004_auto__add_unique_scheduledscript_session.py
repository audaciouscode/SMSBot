...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ScheduledScript', fields ['session']
        db.create_unique('messages_scheduledscript', ['session'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScheduledScript', fields ['session']
        db.delete_unique('messages_scheduledscript', ['session'])
