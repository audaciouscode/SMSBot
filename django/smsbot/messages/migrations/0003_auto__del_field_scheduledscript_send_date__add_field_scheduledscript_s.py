...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ScheduledScript.send_date'
        db.delete_column('messages_scheduledscript', 'send_date')

        # Adding field 'ScheduledScript.sent_date'
        db.add_column('messages_scheduledscript', 'sent_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'ScheduledScript.send_date'
        db.add_column('messages_scheduledscript', 'send_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Deleting field 'ScheduledScript.sent_date'
        db.delete_column('messages_scheduledscript', 'sent_date')
