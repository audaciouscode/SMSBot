...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ScriptTemplate', fields ['slug']
        db.create_unique('messages_scripttemplate', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ScriptTemplate', fields ['slug']
        db.delete_unique('messages_scripttemplate', ['slug'])
