# Django settings for smsbot project.
...
if local_settings.DISABLE_GEODJANGO:
    DATABASES = {
        'default': {
            ...
            'PASSWORD': 'viand22:skew',                  # Not used with sqlite3.
...
MEDIA_ROOT = '/home/moodtext/smsbot/smsbot_django/media/'
...
STATIC_ROOT = '/home/moodtext/smsbot/smsbot_django/static/'
...
SECRET_KEY = 'wy1lq2j*bdxkjdm22&amp;91udxm6q(%=799i5@$t%kc+tlip$pgz&amp;'
...
ROOT_URLCONF = 'smsbot.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'smsbot.wsgi.application'
