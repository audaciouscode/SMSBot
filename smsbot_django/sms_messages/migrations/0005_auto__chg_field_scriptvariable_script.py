...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScriptVariable.script'
        db.alter_column('sms_messages_scriptvariable', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['sms_messages.ScheduledScript']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ScriptVariable.script'
        raise RuntimeError("Cannot reverse this migration. 'ScriptVariable.script' and its values cannot be restored.")
    ...
    models = {
        ...
        'sms_messages.scheduledscript': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'default': "'55027824-4109-402a-94cd-1b918846a5f4'", 'unique': 'True', 'max_length': '36'}),
        ...
        'sms_messages.scriptvariable': {
            ...
            'script': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'variables'", 'null': 'True', 'to': "orm['sms_messages.ScheduledScript']"}),
