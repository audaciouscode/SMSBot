...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledScript.template'
        db.add_column('sms_messages_scheduledscript', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='scripts', null=True, to=orm['sms_messages.ScriptTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledScript.template'
        db.delete_column('sms_messages_scheduledscript', 'template_id')
    ...
    models = {
        ...
        'sms_messages.scheduledscript': {
            ...
            'sent_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'session': ('django.db.models.fields.CharField', [], {'default': "'81363970-f351-400d-a3e8-10c41a456f9b'", 'unique': 'True', 'max_length': '36'}),
