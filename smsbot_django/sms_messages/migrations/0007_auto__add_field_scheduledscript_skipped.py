...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduledScript.skipped'
        db.add_column('sms_messages_scheduledscript', 'skipped',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduledScript.skipped'
        db.delete_column('sms_messages_scheduledscript', 'skipped')
    ...
    models = {
        ...
        'sms_messages.scheduledscript': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'default': "'54b4eba8-375a-4e7a-bf4b-a5b42017427a'", 'unique': 'True', 'max_length': '36'}),
