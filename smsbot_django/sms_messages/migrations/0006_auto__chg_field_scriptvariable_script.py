...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('sms_messages_scriptvariable', 'script_id', self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['sms_messages.ScheduledScript']))
    ...
    models = {
        ...
        'sms_messages.scheduledscript': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'default': "'0628b6a6-1dda-4385-be2f-8b35b3271ba3'", 'unique': 'True', 'max_length': '36'}),
